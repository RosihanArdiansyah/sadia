...
<div class="item col-xs-12 col-sm-12" style="">
		...
		<div class="sp-slides">
			<div class="sp-slide">
			    <iframe width="709" height="400"
src="https://lpmpsulsel.kemdikbud.go.id/images/stories/lpmp-video-20mei.mp4">
</iframe>
			   </div>
			...
			<div class="tmm_row">
				<div class="relative">
					...
					<div style="width:100%;max-height:200px;margin:0 auto;margin-bottom: 0px;">
							<h4 style="font-size:13px;background-color: #11547b;color: #fff;padding: 0.9375rem 1.00rem;">Pengumuman</h4>
				...
				<div class="row">
					...
					<div class="relative">
						...
						<div class="row post-list two-cols">
							...
							<?php
								$queryArtikel = mysql_query("SELECT *FROM $berita WHERE catid = '49' ORDER BY id DESC LIMIT 0,6");
      ...
      <div class="row">
        <div class="large-12 columns">
          ...
          <?php
            ...
            $querySlideImage = mysql_query("SELECT *FROM jos_headline WHERE title_headline = ''  ORDER BY id_headline ASC LIMIT 0,8");
            while ($sli = mysql_fetch_array($querySlideImage)) {
                
                $gambar = "https://lpmpsulsel.kemdikbud.go.id/".$sli['gambar_headline'];
                ?>
                    <div class="item">
                    <img src="<?=$gambar?>" height="100px" />
                    </div>
                <?php
            }
          ?>
