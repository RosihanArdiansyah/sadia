    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
        ...
        <?php include 'v_sidebar.php'; ?>   <!-- Page Sidebar --><!-- Page Sidebar -->
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <form action="<?php echo base_url().'halamanbelakang/rent/edit'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                                ...
                                <div class="panel-body">
                                            ...
                                            <select class="form-control" name="category" required>
                                                <option value="">-Select Option-</option>
                                                    <?php foreach ($category->result() as $row) : ?>
                                                        <?php if($b['rent_category_id']==$row->category_id):?>
                                    ...
                                    <label>Satuan</label> 
                                        <div style="overflow-y:scroll;height:256px;margin-bottom:30px;">
                                            <?php 
                                                $rent_tag=$b['rent_tags'];
                                                $strtag=explode(",", $rent_tag);
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="btn-group btn-group-justified" role="group">
                                        ...
                                        <input type="hidden" name="rent_user_id" value="<?php echo $b['rent_user_id'];?>" required>
            ...
            $(document).ready(function(){
                ...
                function sendFile(file, editor, welEditable) {
                    ...
                    $.ajax({
                        data: data,
                        type: "POST",
                        url: "<?php echo site_url()?>halamanbelakang/rent/upload_image",
                        cache: false,
                        contentType: false,
                        processData: false,
