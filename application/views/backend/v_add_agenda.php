    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <main class="page-content content-wrap">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-calendar"></span><p>Agenda</p><span class="arrow"></span></a>
                            <ul class="sub-menu" style="display: block;">
                                <li class="active"><a href="<?=site_url('halamanbelakang/agenda/add_new')?>">Add New</a></li>
                                <li></li><a href="<?=site_url('halamanbelakang/agenda')?>">Daftar Agenda</a></li>
                            </ul>
                        </li>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <form action="<?php echo base_url().'halamanbelakang/agenda/publish'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="tanggal_mulai" class="form-control date" placeholder="Tanggal_mulai" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Tanggal Selesai Kegiatan</label>
                                            <input type="datetime-local" name="tanggal_selesai" class="form-control date" placeholder="Tanggal_selesai" required>
                                        </div>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <textarea name="contents" id="summernote" height="10"></textarea>
                                        </div>
